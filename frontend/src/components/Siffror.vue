...
.play-again-btn {
	background: linear-gradient(135deg, #667EEA, #764BA2); /* Siffror tema-färg */
	color: white;
	border: none;
...
.results-page .results-title {
	color: #667EEA; /* Siffror tema-färg */
	text-align: center;
	margin-bottom: 15px;
	font-size: 2.2em;
}
...
.results-table thead th {
	background-color: #667EEA; /* Siffror tema-färg */
	color: white;
	font-weight: bold;
...
.results-table tbody tr:hover {
	background-color: #f1f3ff; /* Lätt blå/lila hover för Siffror-temat */
...
.back-from-results-btn {
	margin-top: 30px;
	background: linear-gradient(135deg, #667EEA, #764BA2); /* Siffror tema-färg (tillbaka-knapp) */
	color: white;
	padding: 12px 25px;
	border-radius: 25px;
	font-weight: bold;
