...
export default {
  ...
  data() {
    ...
    // UPPDATERAD: Frågor från databasen för djurkategorin (svenska -> engelska)
    const initialQuestions = [
      {
        question: "Vad betyder 'hund' på engelska?",
        options: ["dog", "cat", "bird", "fish"],
        correctAnswer: "dog",
        hint: "En populärt husdjur som skäller",
        audioText: "dog"
      },
      {
        question: "Vad betyder 'katt' på engelska?",
        options: ["cat", "dog", "rabbit", "hamster"],
        correctAnswer: "cat",
        hint: "Ett litet rovdjur som jagar möss",
        audioText: "cat"
      },
      {
        question: "Vad betyder 'fågel' på engelska?",
        options: ["bird", "fish", "butterfly", "bee"],
        correctAnswer: "bird",
        hint: "Har vingar och kan flyga",
        audioText: "bird"
      },
      {
        question: "Vad betyder 'häst' på engelska?",
        options: ["horse", "cow", "pig", "sheep"],
        correctAnswer: "horse",
        hint: "Ett stort djur som man kan rida på",
        audioText: "horse"
      },
      {
        question: "Vad betyder 'lejon' på engelska?",
        options: ["lion", "tiger", "elephant", "giraffe"],
        correctAnswer: "lion",
        hint: "Kungen av djungeln",
        audioText: "lion"
      }
    ];
