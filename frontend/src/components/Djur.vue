...
export default {
  ...
  {
    question: "Vad är 'cat' på svenska?",
    options: ["katt", "hund", "fågel", "fisk"],
    correctAnswer: "katt",
    hint: "Ett vanligt husdjur som jamar",
    audioText: "cat"
  },
  {
    question: "Vad är 'dog' på svenska?",
    options: ["hund", "katt", "häst", "ko"],
    correctAnswer: "hund",
    hint: "Ett vanligt husdjur som skäller",
    audioText: "dog"
  },
  {
    question: "Vad är 'cow' på svenska?",
    options: ["ko", "gris", "get", "får"],
    correctAnswer: "ko",
    hint: "Ger mjölk",
    audioText: "cow"
  },
  {
    question: "Vad är 'horse' på svenska?",
    options: ["häst", "åsna", "ko", "får"],
    correctAnswer: "häst",
    hint: "Man kan rida på det",
    audioText: "horse"
  },
  {
    question: "Vad är 'pig' på svenska?",
    options: ["gris", "ko", "häst", "får"],
    correctAnswer: "gris",
    hint: "Oftast rosa och gillar lera",
    audioText: "pig"
  },
  {
    question: "Vad är 'sheep' på svenska?",
    options: ["får", "get", "ko", "gris"],
    correctAnswer: "får",
    hint: "Har ull",
    audioText: "sheep"
  },
  {
    question: "Vad är 'goat' på svenska?",
    options: ["get", "får", "ko", "gris"],
    correctAnswer: "get",
    hint: "Har horn och klättrar gärna",
    audioText: "goat"
  },
  {
    question: "Vad är 'bird' på svenska?",
    options: ["fågel", "fisk", "hund", "orm"],
    correctAnswer: "fågel",
    hint: "Kan flyga",
    audioText: "bird"
  },
  {
    question: "Vad är 'fish' på svenska?",
    options: ["fisk", "fågel", "hund", "katt"],
    correctAnswer: "fisk",
    hint: "Simmande djur som lever i vatten",
    audioText: "fish"
  },
  {
    question: "Vad är 'duck' på svenska?",
    options: ["anka", "gås", "kyckling", "tupp"],
    correctAnswer: "anka",
    hint: "Kvackar och gillar vatten",
    audioText: "duck"
  },
  {
    question: "Vad är 'chicken' på svenska?",
    options: ["kyckling", "anka", "gås", "höna"],
    correctAnswer: "kyckling",
    hint: "Litet fjäderbeklätt husdjur som säger kluck kluck",
    audioText: "chicken"
  },
  {
    question: "Vad är 'mouse' på svenska?",
    options: ["mus", "råtta", "kanin", "ekorre"],
    correctAnswer: "mus",
    hint: "Litet gnagardjur som gillar ost",
    audioText: "mouse"
  },
  {
    question: "Vad är 'rabbit' på svenska?",
    options: ["kanin", "mus", "råtta", "ekorre"],
    correctAnswer: "kanin",
    hint: "Hoppar och gillar morötter",
    audioText: "rabbit"
  },
  {
    question: "Vad är 'bear' på svenska?",
    options: ["björn", "varg", "lejon", "tiger"],
    correctAnswer: "björn",
    hint: "Stort djur som gillar honung",
    audioText: "bear"
  },
  {
    question: "Vad är 'lion' på svenska?",
    options: ["lejon", "tiger", "björn", "varg"],
    correctAnswer: "lejon",
    hint: "Kallas djungelns konung",
    audioText: "lion"
  },
  {
    question: "Vad är 'tiger' på svenska?",
    options: ["tiger", "lejon", "björn", "hund"],
    correctAnswer: "tiger",
    hint: "Orange med svarta ränder",
    audioText: "tiger"
  },
  {
    question: "Vad är 'elephant' på svenska?",
    options: ["elefant", "noshörning", "häst", "ko"],
    correctAnswer: "elefant",
    hint: "Stort djur med snabel",
    audioText: "elephant"
  },
  {
    question: "Vad är 'monkey' på svenska?",
    options: ["apa", "björn", "katt", "hund"],
    correctAnswer: "apa",
    hint: "Gillar bananer och klättrar i träd",
    audioText: "monkey"
  },
  {
    question: "Vad är 'snake' på svenska?",
    options: ["orm", "fisk", "ödla", "fågel"],
    correctAnswer: "orm",
    hint: "Långt slingrande reptildjur",
    audioText: "snake"
  },
  {
    question: "Vad är 'fox' på svenska?",
    options: ["räv", "varg", "katt", "hund"],
    correctAnswer: "räv",
    hint: "Rött lurvigt djur som är listigt",
    audioText: "fox"
  }
];
  ...
  computed: {
    ...
    resultsMessage() {
      ...
      if (percentage >= 60) return 'Du kan mycket om djur!';
      return 'Fortsätt öva på djurens namn, du blir bättre!';
    },
    isAnswerCorrect() {
      return this.selectedAnswer === this.currentQuestion.correctAnswer;
    },  },
